...
public class UIController : MonoBehaviour
{
    ...
    IEnumerator BustedEffect()
    {
        ...
        PauseMenu.instance.OnPause.Invoke();
        ...
        PauseMenu.instance.OnResume.Invoke();
        Movement.instance.GetComponent<Rigidbody2D>().drag = 0.1f;
    ...
    IEnumerator EndGame()
    {
        ...
        AudioController.instance.Stop("Music2");
